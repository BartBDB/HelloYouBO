...
if vraag1 == ("A") or ("a"):
    ...
    if vraag3 == ("A") or ("a"):
        ...
        if vraag10 == ("A") or ("a"):
            ...
            print("Er was helaas een agent die hem overhoorde en hem de gevangenis in forceerde.")
            print("Dat is het laatste wat zijn broer had gehoord, en wat hij aan mij verteld had.")
            print("Helaas kan ik nu weinig voor hem doen.")
            print("Dossier gesloten.")
